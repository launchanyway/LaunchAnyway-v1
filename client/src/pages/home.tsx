...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#FAF9F2] text-[#1a1a1a] font-inter selection:bg-[#D4E845] selection:text-black antialiased">
      ...
      {/* Footer */}
      <footer className="fixed bottom-0 left-0 right-0 p-6 md:p-8 flex justify-between items-end text-[11px] font-bold font-mono text-gray-400 pointer-events-none bg-gradient-to-t from-[#FAF9F2] to-transparent h-16 z-40">
        <div className="pointer-events-auto tracking-[0.2em] uppercase">
          © LAUNCHANYWAY 2026
        </div>
        
        <div className="absolute left-1/2 -translate-x-1/2 bottom-4 flex items-center gap-2.5 pointer-events-auto cursor-pointer hover:text-black transition-colors tracking-[0.2em] group">
