    ...
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-0 md:p-6 overflow-y-auto">
          ...
          >
            {/* Header */}
            <div className="bg-[#1e3a8a] p-6 md:p-8 relative overflow-hidden shrink-0">
              <button
                onClick={onClose}
              ...
              <div className="relative z-10">
                <h2 className="text-2xl md:text-3xl font-medium font-inter text-white mb-1 md:mb-2">Apply now</h2>
